...
class ETaggableBehavior extends CActiveRecordBehavior {
    ...
    /**
     * Get current model's tags with fields.
     * @todo: quick implementation, rewrite!
     * @param CDbCriteria $criteria
     * @return array
     */
    public function getTagsWithModelsFields($criteria = null) {
        if(!($tags = $this->cache->get($this->getCacheKey().'WithModelsFields'))){
            ...
            $this->cache->set($this->getCacheKey().'WithModelsFields', $tags);
        }

        return $tags;
    }
    /**
     * Get current model's tags Ids.
     * @todo: quick implementation, rewrite!
     * @param CDbCriteria $criteria
     * @return array
     */
    public function getTagsIds($criteria = null) {
        if(!($tags = $this->cache->get($this->getCacheKey().'Ids'))){
            ...
            $this->cache->set($this->getCacheKey().'Ids', $tags);
        }
